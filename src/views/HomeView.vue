    ...
    <div class="main mw-content-text">
      ...
      <div class="acbox">
        ...
        <div class="leftMB">
          ...
          <div class="downDBox">
            <div class="aText1">敬請注意</div>
            <div class="bLine1"></div>
            <div class="cText1">讓人生氣的魔術！</div>
          </div>
        </div>
        <div class="rightMB">
          <div class="rightUC">
...
.h1t{
  ...
  .kk{
    ...
    &::before{
        ...
        right: -150px;
        bottom: -260px;
        background-image: url("../assets/img/tom.gif");
